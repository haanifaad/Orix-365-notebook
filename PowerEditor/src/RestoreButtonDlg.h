...
// 2 : postit
// 4 : distractionFree
const int buttonStatus_none = 0;            // 0000 0000
...
class RestoreButtonDlg : public StaticDialog
{
public:
    RestoreButtonDlg() = default;
    ...
    void display(bool toShow = true) const override {
        ...
        if (!toShow)
        {
            cmdToShow = (_buttonStatus != buttonStatus_none)?SW_SHOW:SW_HIDE; 
        }
...
protected:
    ...
    int _buttonStatus = buttonStatus_none;
};
